...
function Pessoa(nome, sobrenome) {
  ...
  Pessoa.prototype.nomeCompleto = function() //criação de funcao fora da classe/funcao construtora
  { 
    return this.nome + ' ' + this.sobrenome;
  };
  
  const pessoa1 = new Pessoa('Emilio', 'Bresolin.'); // <- Pessoa = Função construtora
  const pessoa2 = new Pessoa('Helena', 'B.B.'); // <- Pessoa = Função construtora
